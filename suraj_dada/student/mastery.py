...
from suraj_dada.database.models import MasteryScore, Student
from suraj_dada.exceptions import NotFoundError
from suraj_dada.logging_setup import get_logger
from suraj_dada.schemas.student import MasteryScoreResponse, MasterySummaryResponse, WeakTopicInfo
...
class MasteryService:
    ...
    async def update_mastery(
        self, student_id: str, subtopic: str, signals: dict
        ...
        async with self._session_factory() as session:
            ...
            new_score = await self.compute_mastery_update(current_score, signals)

...
from studob.question_bank import AppQuestionService, MetadataFilterService, TestQuestionService
from studob.retrieval import (
...
from studob.student import MasteryService, SessionMemoryService, StudentProfileService
...
class AppContext:
    ...
    async def initialize(self, settings: Settings) -> None:
        ...
        self.retrieval = RetrievalOrchestrator(
            ...
            concept_graph_service=self.concept_graph,
        )

        self.content_engine = ContentEngineService(
            app_questions=self.app_questions,
...
async def get_content_engine(request: Request) -> AsyncGenerator[ContentEngineService, None]:
    yield request.app.state.context.content_engine
